...
#     elastixImageFilter.SetFixedMask(sitk.ReadImage('correct_preproc\\blur\\mask\\mask%04d.png' % 0))
#     elastixImageFilter.SetMovingMask(sitk.ReadImage('correct_preproc\\blur\\mask\\mask%04d.png' % num))

    elastixImageFilter.SetFixedImage(sitk.ReadImage('filtred_median\\img%d.png' % 0))
    elastixImageFilter.SetMovingImage(sitk.ReadImage('filtred_median\\img%d.png'% num))
...
#     res = elastixImageFilter.GetResultImage()
    ...
    imsave('sitkRes_median_filt\\img%d.png' % num, img_reg / img_reg.max())
